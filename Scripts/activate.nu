...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Python\Python Portfolio\Flask Simple Notes'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Python\Python Portfolio\Flask Simple Notes\Scripts\deactivate.nu'
